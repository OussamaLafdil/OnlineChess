...
function updateButtons() {
    ...
    if (me.takebackRequestRecieved) {
        showAcceptDecline();
        opponentActivityLabel.innerHTML = "Adversaire demande de revenir en arrière";

    } else if (me.rematchRequestRecieved) {
        showAcceptDecline();
        opponentActivityLabel.innerHTML = "Adversaire demande de rejouer le match";

    } else if (me.drawRequestRecieved) {
        showAcceptDecline();
        opponentActivityLabel.innerHTML = "Adversaire propose l'égalité";

    } else if (me.takebackRequestSent) {
        takebackButton.className = "btn btn-secondary"
        takebackButton.disabled = true;
        opponentActivityLabel.innerHTML = "Demande envoyée";
        ...
        opponentActivityLabel.innerHTML = "adversaire deconnecté";

    } else if (me.requestDeclined) {
        opponentActivityLabel.innerHTML = "adversaire refuse la demande";

    } else if (me.opponentResigned) {
        opponentActivityLabel.innerHTML = "adversaire est abondonné. Vous avez gagné!";
        
    } else if (me.opponentTimedOut) {
        opponentActivityLabel.innerHTML = "Temps d'adversaire est expiré. Vous avez gagné!";

    } else if (me.timedOut) {
        opponentActivityLabel.innerHTML = "Votre temps est expiré. Vous avez perdu!";

    } else if (me.won) {
        opponentActivityLabel.innerHTML = "Vous avez gagné!";

    } else if (me.lost) {
        opponentActivityLabel.innerHTML = "Vous avez perdu!";

    } else if (me.stalemate) {
        opponentActivityLabel.innerHTML = "Egalité!";
...
function updateText() {
    ...
    bottomPlayerLabel.innerText = " Moi: " + me.score;

    if (me.opponentJoined) {
        topPlayerLabel.innerText = " adversaire: " + opponent.score;
        ...
        topPlayerLabel.innerHTML = "&nbsp;Attendre l'adversaire..."
    }
